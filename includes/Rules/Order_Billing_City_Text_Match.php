...
/**
 * @class Order_Billing_City_Text_Match
 */
class Order_Billing_City_Text_Match extends Abstract_String implements QuickFilterable {
	...
	public function init() {
		$this->title = __( 'Order - Billing City - Text Match', 'automatewoo' );
	}
	...
	public function validate( $order, $compare, $value ) {
		return $this->validate_string( $order->get_billing_city(), $compare, $value );
	}
