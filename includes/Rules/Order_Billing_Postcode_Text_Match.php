...
/**
 * @class Order_Billing_Postcode_Text_Match
 */
class Order_Billing_Postcode_Text_Match extends Abstract_String implements QuickFilterable {
	...
	public function init() {
		$this->title = __( 'Order - Billing Postcode - Text Match', 'automatewoo' );
	}
	...
	public function validate( $order, $compare, $value ) {
		return $this->validate_string( $order->get_billing_postcode(), $compare, $value );
	}
