...
/**
 * Variable_Order_Billing_Country class.
 *
 * @since 6.4.0
 *
 * @class Variable_Order_Billing_Country
 */
class Variable_Order_Billing_Country extends Variable {

	/**
	 * Load description and parameters for variable in admin screen.
	 */
	public function load_admin_details() {
		$this->description = __( 'Displays the billing country for the order.', 'automatewoo' );
	...
	public function get_value( $order, $parameters ) {
		...
		switch ( $format ) {
			...
			case 'full':
			default:
				$return = aw_get_country_name( $order->get_billing_country() );
				break;
		}
